...
* fit_file_parse.c
*
*Code to read .fit binary files, check parameters of data against the
...
*
*Compile format:
* make -f makefile_fit_file_parse
*Call format:
* fit_file_parse [C binary fitted filename] [number of beams] [number of range gates] ...
...
* e.g. fit_file_parse /users/robore/Research/Code/JH/gbr/20011201.gbr.fit 16 120 1200 300 /data/psdcomplexity/eimf/SuperDARN_Data/Velocities/gbr/gbr_20011201_velocities_GEO.dat
*Author: Rob Shore, 2016-11-03.
*
********************************************************************/
...
int main(int argc, char *argv[]){
    ...
    struct OldFitFp *fp = NULL;/*  pointer to fitted data file. */
    ...
    fp = OldFitOpen(in_filename,NULL);
    if (fp==NULL){
